package com.company.content.screen.user;
...
@UiController("content_User.edit")
...
public class UserEdit extends StandardEditor<User> {
    ...
    public void onPostCommit(DataContext.PostCommitEvent event) {
        if (isNewEntity) {
            getApplicationContext().publishEvent(new SingleUserPasswordChangeEvent(getEditedEntity().getUsername(),
