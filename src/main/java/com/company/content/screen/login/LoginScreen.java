package com.company.content.screen.login;
...
@UiController("content_LoginScreen")
...
public class LoginScreen extends Screen {
    ...
    private void onLocalesFieldValueChangeEvent(HasValue.ValueChangeEvent<Locale> event) {
        ...
        UiControllerUtils.getScreenContext(this).getScreens().create(this.getClass(), OpenMode.ROOT).show();
    }
    ...
    private void login() {
        ...
        try {
            loginScreenSupport.authenticate(AuthDetails.of(username, password)
